...
//----------This Installer Script Vesions 2.1.9.0 Beta----------\\
#define AppName "Toolkit Beta"
#define Name "Toolkit Beta"
#define Shortname "Toolkit Beta"
#define AppPublisher "Raptor Repack"
#define AppVersion "2.1.9.0"
#define AppCopyright "© Raptor Repack 2023 Co.Inc"
#define AppExec "Toolkit.exe"
#define AppURL "https://www.github.com/RaptorRepack/Toolkit/releases"
#define AppSupportURL "https://www.twitter.com/RaptorMusk"
#define AppSize "100"   
...
AppComments=Toolkit Beta Designed by Raptor Repack
...
[Messages]
SetupWindowTitle={#AppName} v{#AppVersion} Installer
  
[CustomMessages]
SoundCtrlButtonCaptionSoundOn=Button_On
SoundCtrlButtonCaptionSoundOff=Button_Off
...
//--------  Third page  --------\\
  if CurPageID=wpSelectTasks then begin
    HideComponents;
    WizardForm.Caption:= 'Raptor Repack Beta Installer';
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Position:=poScreenCenter;
    WizardForm.Bevel1.Show;
    Bevel3.Hide;
    ...
    TasksBevel.Hide;
    TasksLbl.Show;
    WizardForm.NextButton.Caption:='Install_Button';
    TasksSeparateBevel.Hide;
  end;
//--------Installation Page--------\\
  if CurPageID=wpInstalling then begin
    ...
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Position:=poScreenCenter;
    WizardForm.Caption:= '{#AppName} v{#AppVersion} Installer';
    WizardForm.Bevel1.Show;
...
//--------Game was successfully installed PAGE--------\\
  if CurPageID=wpFinished then begin
    ...
    WelcomeLbl.Show;
    WelcomeLbl.Left:=145;
    WizardForm.Caption:= 'Finish {#AppName} Repack Game Setup';
