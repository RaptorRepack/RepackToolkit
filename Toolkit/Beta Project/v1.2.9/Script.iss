...
//----------This Installer Script Vesions 1.2.9.0 Beta----------\\
#define AppName "Added Your Game Name"
#define Shortname "Added Your Game Desktop Shortcut Name"
#define AppPublisher "Raptor Repack"
#define AppVersion "1.2.9.0-Beta"
#define AppExec "Raptor.exe" 
#define AppURL "https://github.com/RaptorRepack/Toolkit/releases"
#define AppSupportURL "https://github.com/RaptorRepack/Toolkit/releases"
...
DefaultDirName=D:\{#AppPublisher}\{#AppName}
...
[Messages]
SetupWindowTitle={#AppName} v{#AppVersion} | {#AppPublisher} Beta Installer  
...
//--------Installation Page--------\\
  if CurPageID=wpInstalling then begin
    ...
    WizardForm.Position:=poScreenCenter;
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Caption:= '{#AppName} v{#AppVersion} | {#AppPublisher} Beta Installer';
    WizardForm.Bevel1.Show;
...
//--------Game was successfully installed PAGE--------\\
  if CurPageID=wpFinished then begin
    ...
    WelcomeLbl.Show;
    WelcomeLbl.Left:=145;
    WizardForm.Caption:= 'Finish {#AppName} v{#AppVersion} Setup Wizard';
