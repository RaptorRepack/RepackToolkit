...
//----------This Installer Script Uses Compact Mode----------\\
//----------This Installer Script Designer By Raptor Repack----------\\
//----------This Installer Script Vesions 1.0.0.2022----------\\
#define AppName "Raptor Repack"
#define Name "Raptor Repack"
#define Shortname "Raptor Repack"
#define AppPublisher "Raptor Repack Games"
#define AppVersion "1.0.0.2022"
#define AppExec "Raptor.exe"
#define AppURL "https://www.github.com/raptorrepack"
#define AppSize "100"   
#define Spacesize "100"                
#define SetupName "Install Now"
...
AppComments=Non Crack or Virus Free Official PC Repack Games
DefaultDirName=D:\Raptor Repack\Games\{#AppName}
DefaultGroupName={#AppName}     
OutputBaseFilename={#SetupName}
OutputDir=CompactSetup
...
[Messages]
SetupWindowTitle=Game Versions v1.0.0.0 | Included All DLC or Patch Update | >> Compact Mode Installer <<
...
//--------Installation Page--------\\
  if CurPageID=wpInstalling then begin
    ...
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Position:=poScreenCenter;
    WizardForm.Caption:= 'Installing Status';
    WizardForm.Bevel1.Show;
