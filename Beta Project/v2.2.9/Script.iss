...
//----------This Installer Script Designed by Raptor Repack----------\\
//----------This Installer Script Vesions 2.2.9.0 Beta----------\\
#define AppName "Repack Toolkit"
#define Name "Repack Toolkit"
#define Shortname "Repack Toolkit"
#define AppPublisher "Raptor Repack"
#define AppVersion "2.2.9.0"
#define AppCopyright "© Raptor Repack 2023 Co.Inc"
#define AppExec "Raptor.exe"
#define AppURL "https://www.github.com/RaptorRepack/Toolkit/releases"
#define AppSize "100"   
#define Spacesize "100"                
#define SetupName "Apps"
...
AppComments=Raptor Repack Games 2023
DefaultDirName=D:\Games\{#AppName}
...
AppCopyright=© Raptor Repack 2023 Co.Inc
...
[CustomMessages]
SoundCtrlButtonCaptionSoundOn=@S_On
SoundCtrlButtonCaptionSoundOff=@Off_S
...
begin
  ...
  begin
    ...
    begin
      ...
      Top:=GetScreenHeight-ClientHeight-70
      Left:=GetScreenWidth-ClientWidth-5
    end;
  end else begin
    with WizardForm do
    begin
      Status.SetBounds(0,250,650,30);
      ...
      CancelButton.SetBounds(475,347,150,30);
      MyCancelButton.SetBounds(475,347,150,30);
      ...
      Top:=GetScreenHeight-ClientHeight-100
      Left:=GetScreenWidth-ClientWidth-50
...
//------------------------\\
  ...
  With TasksLbl do begin
    ...
    Parent:=WizardForm;
    //Alignment:=taCenter;
    Caption:='Select The All Components You Want To Install!' + #13#10 + 'Install Now Click Next When You Are Ready To Continue.';
    //Font.Color:=clWhite;
...
ExtractTemporaryFile('zlib1.dll');
  ...
  if CurStep=ssPostInstall then begin
    if DirectXCB.Checked then begin
      ...
      Status.Width := 223;
      Status.Height := 20;
      Exec2(ExpandConstant('{src}\Redist\DirectX\Setup.exe'),'/q',false);
    end;
    if NvidiaPhysx.Checked then begin
      ...
      Status.Width := 227;
      Status.Height := 20;
      Exec2(ExpandConstant('{src}\Redist\Nvidia\PhysX.msi'),'/q',false);
    end;
    if VisualCCB.Checked then begin
      ...
      Status.Width := 227;
      Status.Height := 20;
      Exec2(ExpandConstant('{src}\Redist\Visual\Setup.exe'),'/q',false);
    end;
    if Framework.Checked then begin
      ...
      Status.Width := 227;
      Status.Height := 20;
      Exec2(ExpandConstant('{src}\Redist\MSNT\dotnetfx.exe'),'/q',false);
    end;
  end;
...
//--------  Third page  --------\\
  if CurPageID=wpSelectTasks then begin
    HideComponents;
    WizardForm.Caption:= 'Select The All Task Then Click To Install Now';
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Position:=poScreenCenter;
    WizardForm.Bevel1.Show;
    Bevel3.Hide;
    ...
    TasksBevel.Hide;
    TasksLbl.Show;
    WizardForm.NextButton.Caption:='@I_Now';
    TasksSeparateBevel.Hide;
  end;
//--------Installation Page--------\\
  if CurPageID=wpInstalling then begin
    ...
    WizardForm.WizardSmallBitmapImage.Show;
    WizardForm.Position:=poScreenCenter;
    WizardForm.Caption:= '{#AppName} v{#AppVersion} Game Installing...';
    WizardForm.Bevel1.Show;
...
//--------Game was successfully installed PAGE--------\\
  if CurPageID=wpFinished then begin
    ...
    WelcomeLbl.Show;
    WelcomeLbl.Left:=145;
    WizardForm.Caption:= '{#AppName} v{#AppVersion} Game Installed!';
    WelcomeLbl.Caption:='{#AppName} Was Successfully Installed On Your PC.' + #13#10#13#10 + 'Run The Game From Shortcut In "Start" Menu or Desktop Shortcut.' + #13#10#13#10 + 'Click "Finish" To Exit The Installation Setup.';
  end;
