...
//----------This Installer Script Uses Non Compact Mode----------\\
...
[Messages]
SetupWindowTitle=Game Versions v1.0.0.0 | Included All DLC or Patch Update | >> Non Compact Mode Installer <<
